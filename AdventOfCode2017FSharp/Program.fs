...
let main _ =
    ...
    Runner.run "Day 10 Part 1:" (read "Day10.txt") (Day10.parsePart1 >> Day10.calculatePart1 [|0..255|])
    Runner.run "Day 10 Part 2:" (read "Day10.txt") (Day10.parsePart2 >> Day10.addSecret >> Day10.calculatePart2 [|0..255|])
